...
set :application, 'expatsandaliens'
set :repo_url, 'git@github.com:expatsandaliens/expatsandaliens.git'
...
set :deploy_to, "/home/deploy/apps/expatsandaliens"
...
namespace :deploy do
  ...
  task :setup_config do
    on roles(:app) do
      sudo "ln -nfs #{current_path}/config/nginx.conf /etc/nginx/sites-enabled/expatsandaliens"
